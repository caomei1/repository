...
public class ShoppingController {
	...
	//价格排序
	@RequestMapping(method = RequestMethod.GET, value = "/prolist/desc")
	public String prolistDesc(@ModelAttribute Product product, Model model) {
		List<Product> proList = productService.findAllProductDesc();
		model.addAttribute("proList", proList);
		return "prolist";
	}
