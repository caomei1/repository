 ...
 <div class="car">
  ...
  <table class="orderList">
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="${contextPath}/assets/images/phone1.png" width="85" height="85" /></a></dt>
       <dd>全球最大的中文搜索引擎、致力于让网民更便捷<br /><span class="red">有货：</span>从上海出发</dd>
       <div class="clears"></div>
      </dl>
     </td>
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="${contextPath}/assets/images/phone2.png" width="85" height="85" /></a></dt>
       <dd>全球最大的中文搜索引擎、致力于让网民更便捷<br /><span class="red">有货：</span>从上海出发</dd>
       <div class="clears"></div>
      </dl>
     </td>
    ...
    <tr>
     ...
     <td>
      <dl>
       <dt><a href="proinfo.html"><img src="${contextPath}/assets/images/phone3.png" width="85" height="85" /></a></dt>
       <dd>全球最大的中文搜索引擎、致力于让网民更便捷<br /><span class="red">有货：</span>从上海出发</dd>
       <div class="clears"></div>
      </dl>
     </td>
   ...
   <table class="zongjia" align="right">
    ...
    <tr>
     <td colspan="2" style="height:50px;">
      <a href="success.html"><img src="${contextPath}/assets/images/tijao.png" width="142" height="32" /></a>
     </td>
    </tr>
   </table><!--zongjia/-->
   <div class="clears"></div>
